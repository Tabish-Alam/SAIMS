...
// List names = ["Ali","Usama", "Abdullah","Haroon","Wajid","Khalil","Musa", "Owais","Ansar","Shehroz","Shahzeb"];
...
// List<String> friends = ["Ghani","Saif","Shoaib","Shariq","Rafay","Hamza","Wali","Mohsin","Asim","Ahmed","Ali","Ayaz"];
// print(friends);
// print(friends[6][0]);
...
// Map data = {"name":"Ali","address":"Karachi","age":26,"country":"Pakistan"};
// print(data);
